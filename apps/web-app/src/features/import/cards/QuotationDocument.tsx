    ...
    return (
        <div className={`bg-[#f0eeea] rounded-lg p-10 md:p-14 max-w-3xl mx-auto ${className}`}>
            ...
            <div className="border-t border-b border-neutral-300 py-3 mb-8 flex flex-wrap gap-x-10 gap-y-2 text-sm font-inter">
                ...
                {data.valid_until && (
                    <div>
                        <span className="text-neutral-500 mr-2">Valid Until:</span>
                        <span className="text-neutral-800 tabular-nums">{formatDate(data.valid_until)}</span>
                    </div>
                )}
                {data.quotation_number && (
                    <div>
                        <span className="text-neutral-500 mr-2">#</span>
                        <span className="text-neutral-800 tabular-nums">{data.quotation_number}</span>
                    </div>
                )}
            </div>
            ...
            {(data.client_name || data.client_address) && (
                <div className="mb-8">
                    <p className="text-xs tracking-[0.15em] uppercase text-neutral-400 font-inter mb-1">To</p>
                    {data.client_name && (
