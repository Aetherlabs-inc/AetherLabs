...
const TaskColumn: React.FC<TaskColumnProps> = ({
    ...
    return (
        <div
            className={`flex flex-col w-72 min-w-72 rounded-lg border border-border backdrop-blur-sm transition-all duration-300 ${isOver ? 'column-highlight border-muted/50' : 'bg-card/50'
                }`}
